 ...
 * Generated at: 2020-11-20 07:38:47 UTC
...
// 	String nowPage = (String)request.getAttribute("page");
      ...
      out.write("\t\t<h2>글 답변하기</h2>\n");
      out.write("\t\t<form action=\"BoardReplyPro.bo\" method=\"post\" name=\"replyForm\">\n");
      out.write("\t\t\t<!-- 답변 글 작성에 필요한 게시물 정보 중 입력받지 않는 정보도 함께 전달 -->\n");
      ...
      out.print(article.getBoard_re_ref() );
      out.write("\" />\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"board_re_lev\" value=\"");
      out.print(article.getBoard_re_lev() );
      out.write("\" />\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"board_re_seq\" value=\"");
      out.print(article.getBoard_re_seq() );
      out.write("\" />\n");
      out.write("\t\t\t<table>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td class=\"td_left\"><label for=\"board_name\">글쓴이</label></td>\n");
      out.write("\t\t\t\t\t<td class=\"td_right\"><input type=\"text\" name=\"board_name\" required=\"required\" /></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td class=\"td_left\"><label for=\"board_pass\">비밀번호</label></td>\n");
      out.write("\t\t\t\t\t<td class=\"td_right\"><input type=\"password\" name=\"board_pass\" required=\"required\" /></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<td class=\"td_left\"><label for=\"board_subject\">제목</label></td>\n");
      out.write("\t\t\t\t\t<td class=\"td_right\"><input type=\"text\" name=\"board_subject\" required=\"required\" /></td>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t<tr>\n");
      ...
      out.write("\t\t\t\t<input type=\"submit\" value=\"답변글등록\">&nbsp;&nbsp;\n");
